...
class BandsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create band" do
    assert_difference('Band.count') do
      post bands_url, params: { band: { —skip-template-engine: @band.—skip-template-engine } }
    end
  ...
  test "should update band" do
    patch band_url(@band), params: { band: { —skip-template-engine: @band.—skip-template-engine } }
